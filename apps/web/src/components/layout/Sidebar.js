...
import { LayoutDashboard, School, Users, Package, Briefcase, Truck, Car, Map, History, DollarSign, Radio, MessageCircle, LogOut, Settings, UserCircle, } from 'lucide-react';
...
export const navigation = [
    ...
    },
    {
        ...
        items: [
            ...
            { to: '/passageiros-corporativos', icon: Briefcase, label: 'Passageiros Corp.' },
...
export function SidebarContent({ mobile = false, onNavigate }) {
    ...
    const routeModuleMap = {
        ...
        '/alunos': 'alunos',
        '/entregas': 'entregas',
        '/passageiros-corporativos': 'passageiros_corporativos',
